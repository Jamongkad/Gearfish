    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3>Code Sample</h3>
                <pre><code>curl --include --request GET "https://dev.gearfish.com/api/<?php echo $upload_data->id?>?page=1&apikey=<span class="api-key-id"><?php echo $upload_data->key?></span>"</code></pre>
            </div>
        </div>
    </div>
</div>
